import { _ as __unplugin_components_0$2 } from "./Modal-6bfb23d9.js";
import { q as computed, z as reactive, w as watch, y as inject, d as defineComponent, o as openBlock, c as createBlock, a3 as withCtx, a2 as createBaseVNode, b as createElementBlock, a7 as toDisplayString, r as resolveComponent, f as createVNode, a8 as withDirectives, a4 as createTextVNode, e as createCommentVNode, $ as renderSlot, u as unref, g as ref } from "./runtime-core.esm-bundler-9a0ba37c.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-cc2b3d55.js";
import { v as vModelText, a as vModelDynamic } from "./runtime-dom.esm-bundler-32f2d5b0.js";
import { _ as __unplugin_components_1$1 } from "./CoreButton-345de535.js";
import { u as useRoute, b as useRouter } from "./vue-router-944476c0.js";
import { b as useOnline } from "./index-92728829.js";
import { p as isSignInWithEmailLink, g as getAuth, s as sendSignInLinkToEmail, q as signInWithEmailLink, t as signInWithRedirect, u as getRedirectResult, G as GithubAuthProvider, v as GoogleAuthProvider, T as TwitterAuthProvider } from "./index-90ebcfae-3aa38dd7.js";
import { u as useStore } from "./vuex.esm-bundler-4cb42885.js";
import "./useRecentDocs-5169304a.js";
import { b as addCheckout } from "./firestore-20470781.js";
const providers = {
...
const _sfc_main$9 = defineComponent({
  components: {
    Modal: __unplugin_components_0$2
  },
  props: {
    error: {
      type: String
...
const _hoisted_1$b = /* @__PURE__ */ createBaseVNode("span", null, "Complete subscription at Stripe", -1);
const _hoisted_2$9 = {
  key: 0,
...
const _hoisted_4$6 = /* @__PURE__ */ createBaseVNode("p", null, "You will be redirected to Stripe in just a moment...", -1);
const _hoisted_5$5 = [
  _hoisted_4$6
];
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Modal = __unplugin_components_0$2;
  return openBlock(), createBlock(_component_Modal, { onClose: _ctx.close }, {
    ...
    default: withCtx(() => [
      createBaseVNode("div", null, [
        _ctx.error ? (openBlock(), createElementBlock("p", _hoisted_2$9, toDisplayString(_ctx.error), 1)) : (openBlock(), createElementBlock("div", _hoisted_3$8, _hoisted_5$5))
      ])
    ]),
    _: 1
  }, 8, ["onClose"]);
}
const __unplugin_components_4 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$6]]);
...
const _hoisted_1$a = /* @__PURE__ */ createBaseVNode("span", null, [
  /* @__PURE__ */ createTextVNode("Complete "),
  /* @__PURE__ */ createBaseVNode("strong", null, "magic link"),
  /* @__PURE__ */ createTextVNode(" sign-in")
], -1);
const _hoisted_2$8 = /* @__PURE__ */ createBaseVNode("p", null, "For your security, please confirm your email address.", -1);
const _hoisted_3$7 = { class: "flex items-center gap-3 cursor-text rounded px-3 py-2 shadow outline-none mt-4 border" };
const _hoisted_4$5 = {
  key: 0,
  class: "mt-1 text-red-500"
};
  ...
  return openBlock(), createBlock(_component_Modal, { onClose: _ctx.close }, {
    ...
    default: withCtx(() => [
      createBaseVNode("div", null, [
        ...
        _ctx.form.error ? (openBlock(), createElementBlock("p", _hoisted_4$5, toDisplayString(_ctx.form.error), 1)) : _ctx.form.confirming || _ctx.form.confirmed ? (openBlock(), createElementBlock("p", _hoisted_5$4, [
...
const __unplugin_components_3 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$5]]);
const _hoisted_1$9 = { class: "bg-gray-100 dark:bg-darkest flex flex-col gap-4 p-4 rounded shadow" };
...
const IconGitHub = { render: render$4 };
const _hoisted_1$7 = {
  fill: "currentColor",
  viewBox: "0 0 256 262",
  xmlns: "http://www.w3.org/2000/svg",
...
const _hoisted_2$6 = /* @__PURE__ */ createBaseVNode("path", { d: "M255.878 133.451c0-10.734-.871-18.567-2.756-26.69H130.55v48.448h71.947c-1.45 12.04-9.283 30.172-26.69 42.356l-.244 1.622 38.755 30.023 2.685.268c24.659-22.774 38.875-56.282 38.875-96.027" }, null, -1);
const _hoisted_3$5 = /* @__PURE__ */ createBaseVNode("path", { d: "M130.55 261.1c35.248 0 64.839-11.605 86.453-31.622l-41.196-31.913c-11.024 7.688-25.82 13.055-45.257 13.055-34.523 0-63.824-22.773-74.269-54.25l-1.531.13-40.298 31.187-.527 1.465C35.393 231.798 79.49 261.1 130.55 261.1" }, null, -1);
const _hoisted_4$4 = /* @__PURE__ */ createBaseVNode("path", { d: "M56.281 156.37c-2.756-8.123-4.351-16.827-4.351-25.82 0-8.994 1.595-17.697 4.206-25.82l-.073-1.73L15.26 71.312l-1.335.635C5.077 89.644 0 109.517 0 130.55s5.077 40.905 13.925 58.602l42.356-32.782" }, null, -1);
const _hoisted_5$3 = /* @__PURE__ */ createBaseVNode("path", { d: "M130.55 50.479c24.514 0 41.05 10.589 50.479 19.438l36.844-35.974C195.245 12.91 165.798 0 130.55 0 79.49 0 35.393 29.301 13.925 71.947l42.211 32.783c10.59-31.477 39.891-54.251 74.414-54.251" }, null, -1);
const _hoisted_6$2 = [
  _hoisted_2$6,
  _hoisted_3$5,
  _hoisted_4$4,
...
const IconGoogle = { render: render$3 };
const _hoisted_1$6 = {
  fill: "currentColor",
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 248 204",
...
const IconTwitter = { render: render$2 };
const _sfc_main$6 = defineComponent({
  components: {
    Button: __unplugin_components_1$1,
...
const _hoisted_2$4 = /* @__PURE__ */ createBaseVNode("span", null, "Continue with GitHub", -1);
const _hoisted_3$3 = /* @__PURE__ */ createBaseVNode("span", null, "Continue with Google", -1);
const _hoisted_4$3 = /* @__PURE__ */ createBaseVNode("span", null, "Continue with Twitter", -1);
const _hoisted_5$2 = {
  key: 1,
  class: "text-red-500"
};
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("section", _hoisted_1$5, [
    ...
    _ctx.form.error ? (openBlock(), createElementBlock("p", _hoisted_5$2, toDisplayString(_ctx.form.error), 1)) : _ctx.form.confirming ? (openBlock(), createElementBlock("p", _hoisted_6$1, _hoisted_8$1)) : createCommentVNode("", true)
  ]);
}
const __unplugin_components_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$4]]);
...
const _hoisted_1$4 = { class: "border border-current cursor-pointer flex gap-3 items-center px-3 py-2 rounded shadow focus-within:outline-none focus-within:ring" };
const _hoisted_2$3 = ["placeholder", "type"];
...
const __unplugin_components_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$3]]);
const _sfc_main$4 = defineComponent({
  components: {
    Button: __unplugin_components_1$1,
    EnvelopeIcon: render$5,
    FormText: __unplugin_components_0$1
  },
  props: {
    form: {
      default: () => ({
...
const _hoisted_2$2 = /* @__PURE__ */ createBaseVNode("span", null, [
...
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_EnvelopeIcon = resolveComponent("EnvelopeIcon");
  const _component_FormText = __unplugin_components_0$1;
  const _component_Button = resolveComponent("Button");
  return openBlock(), createElementBlock("section", _hoisted_1$3, [
    ...
    _ctx.form.error ? (openBlock(), createElementBlock("p", _hoisted_3$2, toDisplayString(_ctx.form.error), 1)) : _ctx.form.confirming || _ctx.form.confirmed ? (openBlock(), createElementBlock("p", _hoisted_4$2, [
      createBaseVNode("span", null, [
        createTextVNode("Sending your magic link... "),
        _ctx.form.confirmed ? (openBlock(), createElementBlock("strong", _hoisted_5$1, "email sent")) : createCommentVNode("", true)
      ])
    ])) : createCommentVNode("", true)
  ]);
}
const __unplugin_components_1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$2]]);
...
const _sfc_main$3 = defineComponent({
  components: {
    ...
    AuthMagicLink: __unplugin_components_1,
    AuthSocialLinks: __unplugin_components_2$1,
    CoreButton: __unplugin_components_1$1,
    CorePanel: _sfc_main$7
  },
  props: {
    tier: {
      default: () => ({
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_CoreButton = __unplugin_components_1$1;
  const _component_AuthMagicLink = __unplugin_components_1;
  const _component_AuthSocialLinks = __unplugin_components_2$1;
  const _component_CorePanel = _sfc_main$7;
...
const __unplugin_components_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$1]]);
...
const _sfc_main = defineComponent({
  components: {
    AuthMagicLinkModal: __unplugin_components_3,
    AuthStripeModal: __unplugin_components_4,
    AuthTier: __unplugin_components_2,
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_CheckListItem = _sfc_main$1;
  const _component_CheckList = _sfc_main$2;
  const _component_AuthTier = __unplugin_components_2;
  const _component_AuthMagicLinkModal = __unplugin_components_3;
  const _component_AuthStripeModal = __unplugin_components_4;
...
//# sourceMappingURL=AuthTiers-9903d4f9.js.map
