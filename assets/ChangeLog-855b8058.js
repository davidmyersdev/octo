...
import { s as subscription, u as user } from "./account-a08c9355.js";
import { e as defineComponent, o as openBlock, c as createElementBlock, d as createBaseVNode, t as toDisplayString, s as renderSlot, n as createCommentVNode, _ as _export_sfc, r as ref, l as onMounted, k as createBlock, w as withCtx, j as createTextVNode, v as unref, h as createVNode } from "./_plugin-vue_export-helper-ea9be126.js";
      ...
      return showChangeLog.value ? (openBlock(), createBlock(Modal, {
        ...
        footer: withCtx(() => [
          createBaseVNode("div", _hoisted_21, [
            ...
            !unref(subscription).pro ? (openBlock(), createBlock(_component_CoreLink, {
              key: 0,
              onClick: trackCta,
              to: { path: "/account" },
              ...
              _: 1
            })) : !unref(user) ? (openBlock(), createBlock(_component_CoreLink, {
              key: 1,
              onClick: trackCta,
              to: { path: "/account" },
              class: "text-blue-400 button-flat button-color-surface button-size-medium"
...
//# sourceMappingURL=ChangeLog-855b8058.js.map
