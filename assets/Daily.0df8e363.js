import{_ as i,ab as n,l as a,X as d,a1 as c,ac as l,r as u,a as m,d as h,f as _}from"./index.ffc7d12a.js";import f from"./Editor.107cf022.js";import"./Editor.4af8d90d.js";const y={name:"Daily",components:{Editor:f},computed:{daily(){return this.$store.getters.daily}},methods:{async buildTemplate(){try{const t=(await n(()=>import("./quotes.6145aced.js"),[])).default,e=t[Math.floor(Math.random()*t.length)];return`#daily
