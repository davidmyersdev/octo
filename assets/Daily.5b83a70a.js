import{h as a}from"./moment.08a7f518.js";import n from"./Editor.9160747e.js";import{n as i,j as r,A as c,l}from"./index.d60f6a07.js";import"./Editor.2aa5a3f1.js";import"./MarkdownEditor.umd.6e7ef77c.js";import"./vendor.c2056232.js";var d=function(){var t=this,e=t.$createElement,o=t._self._c||e;return t.daily?o("Editor",{attrs:{id:t.daily.id,initialFocus:"end"}}):t._e()},u=[];const h={name:"Daily",components:{Editor:n},computed:{daily(){return this.$store.getters.daily}},methods:{async buildTemplate(){const t=await fetch("/quotes.json").then(o=>o.json()).catch(o=>[]),e=t[Math.floor(Math.random()*t.length)];return`#daily
