import{_ as i,a6 as n,m as a,$ as d,a1 as c,ah as l,r as m,a as u,d as h,f as _}from"./index.14ef8b68.js";import f from"./Editor.8f946e96.js";import"./Editor.1ed48451.js";const y={name:"Daily",components:{Editor:f},computed:{daily(){return this.$store.getters.daily}},methods:{async buildTemplate(){try{const t=(await n(()=>import("./quotes.6145aced.js"),[])).default,e=t[Math.floor(Math.random()*t.length)];return`#daily
