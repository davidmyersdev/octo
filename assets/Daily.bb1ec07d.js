import{_ as i,a6 as n,m as a,$ as d,a1 as c,aj as l,r as m,a as u,e as h,f as _}from"./index.2a504f88.js";import f from"./Editor.204bcb68.js";import"./Editor.53acb22f.js";const y={name:"Daily",components:{Editor:f},computed:{daily(){return this.$store.getters.daily}},methods:{async buildTemplate(){try{const t=(await n(()=>import("./quotes.6145aced.js"),[])).default,e=t[Math.floor(Math.random()*t.length)];return`#daily
