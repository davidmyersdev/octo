import{_ as i,a7 as n,p as a,a0 as d,a2 as c,ai as l,r as u,a as m,d as h,f as _}from"./index.0a5cadfe.js";import f from"./Editor.bb8636e1.js";import"./Editor.5908d5aa.js";const y={name:"Daily",components:{Editor:f},computed:{daily(){return this.$store.getters.daily}},methods:{async buildTemplate(){try{const t=(await n(()=>import("./quotes.6145aced.js"),[])).default,e=t[Math.floor(Math.random()*t.length)];return`#daily
