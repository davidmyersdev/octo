import { _ as __unplugin_components_0$2 } from "./CoreDivider-38ff7a5c.js";
import { h as hooks } from "./moment-f63e338d.js";
import { D as DISCARD_DOCUMENT, R as RESTORE_DOCUMENT, k as MERGE_DOCUMENTS } from "./actions-a6a34f3c.js";
import { w as withModifiers, v as vModelText, b as withKeys } from "./runtime-dom.esm-bundler-32f2d5b0.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-cc2b3d55.js";
import { o as openBlock, b as createElementBlock, a2 as createBaseVNode, f as createVNode, a7 as toDisplayString, e as createCommentVNode, a4 as createTextVNode, a8 as withDirectives, Q as Fragment, a0 as renderList, ab as mergeProps, n as normalizeClass } from "./runtime-core.esm-bundler-9a0ba37c.js";
import { _ as _sfc_main$2 } from "./Tag.vue_vue_type_script_setup_true_lang-7d59ccc4.js";
import { o as open } from "./router-874b08b6.js";
...
const _sfc_main$1 = {
  components: {
    CoreDivider: __unplugin_components_0$2
  },
  props: {
    id: String,
    text: String,
...
const _hoisted_3$1 = { class: "flex items-center justify-between p-4" };
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_CoreDivider = __unplugin_components_0$2;
  return openBlock(), createElementBlock("div", _hoisted_1$1, [
    ...
    createBaseVNode("div", _hoisted_3$1, [
      ...
      $props.allowDiscard ? (openBlock(), createElementBlock("div", _hoisted_5$1, [
        $props.discardedAt ? (openBlock(), createElementBlock("button", {
          ...
          class: "destroy button-flat button-size-medium button-color-surface text-sm text-red-500"
        }, _hoisted_11$1))
      ])) : createCommentVNode("", true)
    ])
  ]);
}
const __unplugin_components_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
const REGEX_QUERY = /^\/(?<regex>.+)\/(?<flags>[a-z]*)$/s;
const _sfc_main = {
  emits: ["update:query"],
  components: {
    Doc: __unplugin_components_0$1,
    Tag: _sfc_main$2
  },
  props: {
    cols: {
...
const _hoisted_11 = { class: "flex align-items-bottom" };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Doc = __unplugin_components_0$1;
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    createBaseVNode("div", _hoisted_8, [
      createBaseVNode("button", {
        onClick: _cache[0] || (_cache[0] = (...args) => $options.toggleIsEditing && $options.toggleIsEditing(...args)),
        class: "button button-size-medium button-color-gray shadow"
      }, toDisplayString($data.isEditing ? "Cancel" : "Manage Docs"), 1),
      $options.canMerge ? (openBlock(), createElementBlock("button", {
        key: 0,
        onClick: _cache[1] || (_cache[1] = (...args) => $options.mergeDocs && $options.mergeDocs(...args)),
        class: "button button-size-medium button-color-gray shadow ml-2"
      }, "Merge Docs")) : createCommentVNode("", true),
      createBaseVNode("div", null, [
        $data.isEditing ? (openBlock(), createElementBlock("p", _hoisted_9, "Select two or more docs to merge them together.")) : createCommentVNode("", true)
      ])
    ]),
    ...
    createBaseVNode("div", {
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList($options.visibleDocs, (doc) => {
        return openBlock(), createElementBlock("div", {
          key: doc.id,
          onKeypress: withKeys(withModifiers(($event) => $options.selectDoc(doc.id), ["prevent"]), ["enter"]),
          onClick: ($event) => $options.selectDoc(doc.id),
          tabindex: "0",
          class: "rounded relative cursor-pointer outline-none focus:ring"
        }, [
          createVNode(_component_Doc, mergeProps(doc, {
            allowDiscard: $data.isEditing,
            class: "h-96"
          }), null, 16, ["allowDiscard"]),
          doc.selected ? (openBlock(), createElementBlock("div", _hoisted_15, _hoisted_17)) : createCommentVNode("", true)
        ], 40, _hoisted_14);
      }), 128)),
...
//# sourceMappingURL=DocList-8475a39d.js.map
