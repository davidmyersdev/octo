import { u as useCssVars } from "./runtime-dom.esm-bundler-32f2d5b0.js";
import { D as Do, H as Ho } from "./client-2de13258.js";
import { d as defineComponent, o as openBlock, b as createElementBlock, r as resolveComponent, a2 as createBaseVNode, f as createVNode } from "./runtime-core.esm-bundler-9a0ba37c.js";
import { O as OverlayScrollbars } from "./overlayscrollbars.esm-084eb65b.js";
import { g as getAuth } from "./index-90ebcfae-3aa38dd7.js";
import { r as ref, g as getStorage, u as uploadBytes } from "./index.esm2017-1fab45ee.js";
import { g as getAugmentedNamespace } from "./_commonjsHelpers-dd024a83.js";
import { n as nanoid, c as customAlphabet } from "./index.browser-0a05c6e5.js";
import { T as Tag, s as syntaxHighlighting, H as HighlightStyle, a as syntaxTree, t as tags$3 } from "./index-9e94dbc0.js";
import { m as matchStarts, H as HASHTAG_CODES, c as matchHashtagPrefix, d as matchHashtag } from "./doc-aa27f392.js";
import { _ as __vitePreload } from "./preload-helper-5f15640e.js";
import { S as StateField, R as RangeSet } from "./index-73136136.js";
import { E as EditorView, D as Decoration } from "./index-f4eaee3d.js";
import { a as adjust, i as invert } from "./invert-f9d6c8a5.js";
import { _ as _$1, d as darken, l as lighten } from "./darken-fdc59d89.js";
import { l as luminance } from "./luminance-d8ea28d2.js";
...
const theme$2 = syntaxHighlighting(
...
const hashtags = (config) => {
  return [
    { type: "completion", value: completions$1(config) },
    { type: "default", value: theme$2 },
...
const contrast = (color1, color2) => {
  ...
  return _$1.lang.round(_$1.lang.clamp(ratio, 1, 10));
};
...
const makeColors = (color) => {
  ...
  return {
    ...
    text: contrast$1(lighter, color) > contrast$1(darker, color) ? lighter : darker
  };
};
const colors = {
...
const preview = (text) => {
  return {
    ...
    toDOM: () => {
      ...
      __vitePreload(() => import("./mermaid.core-00eaf26b.js"), true ? ["assets/mermaid.core-00eaf26b.js","assets/_commonjsHelpers-dd024a83.js","assets/_commonjs-dynamic-modules-58f2b0ec.js","assets/transform-92e5ec77.js","assets/invert-f9d6c8a5.js","assets/darken-fdc59d89.js","assets/ordinal-af0bbe35.js"] : void 0).then(({ default: mermaid2 }) => {
...
const widget = async (_config) => {
  if (!state.isMermaidLoaded) {
    try {
      const { default: mermaid2 } = await __vitePreload(() => import("./mermaid.core-00eaf26b.js"), true ? ["assets/mermaid.core-00eaf26b.js","assets/_commonjsHelpers-dd024a83.js","assets/_commonjs-dynamic-modules-58f2b0ec.js","assets/transform-92e5ec77.js","assets/invert-f9d6c8a5.js","assets/darken-fdc59d89.js","assets/ordinal-af0bbe35.js"] : void 0);
      mermaid2.initialize({
        startOnLoad: false,
        theme: "base",
        themeCSS: themeCss,
      ...
      const { default: mindmap } = await __vitePreload(() => import("./mermaid-mindmap.core-215c9eb9.js"), true ? ["assets/mermaid-mindmap.core-215c9eb9.js","assets/preload-helper-5f15640e.js"] : void 0);
  ...
  const previewDecoration = (text) => Decoration.widget({
    block: true,
    side: -1,
    widget: preview(text)
  });
  const decorate = (state2) => {
    const widgets = [];
    syntaxTree(state2).iterate({
      enter: ({ type, from, to }) => {
        if (type.name === "FencedCode") {
          ...
          const block = state2.sliceDoc(from, to);
          const isMermaid = /^`+mermaid(?:\s|$)/.test(block);
          if (isMermaid) {
            const position = state2.doc.lineAt(from).from;
...
const isCursorInRange = (state2, from, to) => {
  return state2.selection.ranges.some((range) => {
    return hasOverlap(from, to, range.from, range.to);
  });
};
const replacements = (config) => {
  const referenceDecoration = (text) => Decoration.replace({
    ...
    syntaxTree(state2).iterate({
      enter: ({ type, from, to }) => {
        if (type.name === "Reference") {
          ...
          const id = state2.sliceDoc(from + 2, to - 2);
          const doc = config.docs.find((doc2) => doc2.id === id);
          if (doc && !isCursorInRange(state2, from + 2, to - 2)) {
  ...
  const stateField = StateField.define({
    ...
    update(_references, { state: state2 }) {
      return decorate(state2);
    },
    provide(field) {
      return EditorView.decorations.from(field);
...
const grammar$1 = {
  defineNodes: [
    ...
    {
      name: "ReferenceMark",
      style: [tags$1.referenceMark, tags$3.processingInstruction]
    }
  ],
  parseInline: [
    {
      name: "ReferenceStart",
      parse(cx, next, pos) {
        return next === LEFT_BRACKET_CODE && cx.char(pos + 1) === LEFT_BRACKET_CODE ? cx.addDelimiter(ReferenceStartDelimiter, pos, pos + 2, true, false) : -1;
      },
      after: "Emphasis"
    },
    {
      ...
      parse(cx, next, pos) {
        ...
        if (Number.isInteger(openIndex)) {
          ...
          let ref2 = parts[openIndex] = cx.elt("Reference", start, end, content);
          return ref2.to;
        }
        return -1;
      },
...
const grammar = (_config) => {
  return {
    ...
    parseInline: [
      {
        name: "ClickableUrl",
        parse: (inline, nextChar, index) => {
          if (nextChar !== 58 || inline.char(index + 1) !== 47 || inline.char(index + 2) !== 47 || inline.char(index + 3) === 47)
            return -1;
...
const Editor_vue_vue_type_style_index_0_scoped_74dc4fd0_lang = "";
const __default__ = defineComponent({
  ...
  computed: {
    ...
    editor() {
      var _a;
      return (_a = this.$refs.editable) == null ? void 0 : _a.instance;
    },
    maxWidthInChars() {
  ...
  beforeMount() {
    mermaid().then((plugins2) => {
      this.lazyPlugins.push(...plugins2);
    }).catch((error) => {
      console.log("[mermaid]", error);
    });
  },
...
const _hoisted_1 = { class: "editor flex flex-col flex-grow flex-shrink min-h-0 min-w-0 w-full" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Ink = resolveComponent("Ink");
  return openBlock(), createElementBlock("div", {
    onClick: _cache[1] || (_cache[1] = (...args) => _ctx.focusEditor && _ctx.focusEditor(...args)),
    class: "flex flex-col flex-grow relative"
  }, [
    createBaseVNode("div", _hoisted_1, [
      createVNode(_component_Ink, {
        ref: "editable",
        class: "ink-editor flex flex-col flex-grow flex-shrink min-h-0",
...
const Editor = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-74dc4fd0"]]);
export {
  Editor as E
};
//# sourceMappingURL=Editor-26a7a932.js.map
