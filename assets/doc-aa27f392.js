...
const exportPrivateKey = async (key) => {
  const base64 = pack$1(await window.crypto.subtle.exportKey("pkcs8", key));
  return `-----BEGIN PRIVATE KEY-----
${base64}
-----END PRIVATE KEY-----`;
};
const exportPublicKey = async (key) => {
  const base64 = pack$1(await window.crypto.subtle.exportKey("spki", key));
...
const formatMatch = (match) => {
  var _a, _b, _c;
  const boundary = ((_a = match.groups) == null ? void 0 : _a.boundary) || "";
  const sign = ((_b = match.groups) == null ? void 0 : _b.sign) || "";
  const tag = ((_c = match.groups) == null ? void 0 : _c.tag) || "";
  return {
...
const pack = async (doc, { preferEncryption = null, publicKey = null }) => {
...
export {
  Doc as D,
  HASHTAG_CODES as H,
  parseCodeblocks as a,
  parseReferences as b,
  matchHashtagPrefix as c,
  matchHashtag as d,
  exportKeys as e,
  generateKeys as g,
  matchStarts as m,
...
//# sourceMappingURL=doc-aa27f392.js.map
