import { j as indentNodeProp, v as continuedIndent, i as foldNodeProp, d as styleTags, t as tags, u as LRLanguage, b as LanguageSupport, a as syntaxTree } from "./index-9e94dbc0.js";
import { E as ExternalTokenizer, L as LRParser } from "./index-08d7a392.js";
import { i as ifNotIn, c as completeFromList } from "./index-9d34c1ff.js";
import "./index-73136136.js";
import "./index-f4eaee3d.js";
const whitespace = 34, LineComment = 1, BlockComment = 2, String$1 = 3, Number = 4, Bool = 5, Null = 6, ParenL = 7, ParenR = 8, BraceL = 9, BraceR = 10, BracketL = 11, BracketR = 12, Semi = 13, Dot = 14, Operator = 15, Punctuation = 16, SpecialVar = 17, Identifier = 18, QuotedIdentifier = 19, Keyword = 20, Type = 21, Builtin = 22;
function isAlpha(ch) {
...
function tokensFor(d) {
  return new ExternalTokenizer((input) => {
    ...
    } else if (next == 48 && (input.next == 98 || input.next == 66) || (next == 98 || next == 66) && input.next == 39) {
...
//# sourceMappingURL=index-0ad9c5ab.js.map
