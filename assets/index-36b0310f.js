...
import { g as getAuth, r as registerVersion, i as initializeApp, c as connectAuthEmulator } from "./index-90ebcfae-3aa38dd7.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    !_ctx.home && !_ctx.publicDoc && !_ctx.flow ? (openBlock(), createBlock(_component_AsyncChangeLog, { key: 0 })) : createCommentVNode("", true),
    createVNode(_component_AppLayout, { name: "dashboard" }, {
      default: withCtx(() => [
        createVNode(_component_AppPage, {
