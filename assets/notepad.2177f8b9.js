import{_ as d,a6 as n,A as o,$ as i,a1 as c,ah as l,r as u,o as m,n as h,e as _}from"./index.f0efdd9c.js";import f from"./_doc_.d9c00d81.js";import"./Editor.c6ef372d.js";const y={components:{Editor:f},computed:{daily(){return this.$store.getters.daily}},methods:{async buildTemplate(){try{const t=(await n(()=>import("./quotes.6145aced.js"),[])).default,e=t[Math.floor(Math.random()*t.length)];return`#daily
