import{_ as d,a6 as n,A as o,$ as i,a1 as c,ah as l,r as u,o as m,n as h,d as _}from"./index.b6a09ca3.js";import f from"./_doc_.a9c0e015.js";import"./Editor.4a99a88c.js";const y={components:{Editor:f},computed:{daily(){return this.$store.getters.daily}},methods:{async buildTemplate(){try{const t=(await n(()=>import("./quotes.6145aced.js"),[])).default,e=t[Math.floor(Math.random()*t.length)];return`#daily
