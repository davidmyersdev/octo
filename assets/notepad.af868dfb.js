import{_ as n,a6 as d,A as o,$ as i,a1 as c,ah as l,r as u,o as m,n as h,d as _}from"./index.81564696.js";import f from"./_doc_.969d3299.js";import"./Editor.a219c74c.js";const y={components:{Editor:f},computed:{daily(){return this.$store.getters.daily}},methods:{async buildTemplate(){try{const t=(await d(()=>import("./quotes.6145aced.js"),[])).default,e=t[Math.floor(Math.random()*t.length)];return`#daily
