import { _ as __unplugin_components_0 } from "./Extendable-dea60239.js";
import { e as vModelRadio, d as vModelCheckbox, v as vModelText } from "./runtime-dom.esm-bundler-eaea4b0e.js";
import { e as defineComponent, i as inject, _ as _export_sfc, o as openBlock, c as createElementBlock, h as createVNode, w as withCtx, d as createBaseVNode, ab as withDirectives, v as unref, j as createTextVNode, n as createCommentVNode, ad as createStaticVNode, s as renderSlot, f as computed, D as isRef, k as createBlock } from "./_plugin-vue_export-helper-ea9be126.js";
import { _ as __unplugin_components_0$1 } from "./CoreLink-6737d303.js";
import { s as subscription } from "./account-a08c9355.js";
import { l as SET_EDITOR_IMAGES_ENABLED, i as SET_EDITOR_LIGATURES, h as SET_EDITOR_LISTS_ENABLED, g as SET_EDITOR_READABILITY_ENABLED, o as SET_EDITOR_READABILITY_MAX_WIDTH, f as SET_EDITOR_READABILITY_WORDS_PER_MINUTE, k as SET_EDITOR_IMAGES_SHOW_CAPTIONS, e as SET_EDITOR_SPELLCHECK, d as SET_EDITOR_TAB_SIZE, c as SET_EDITOR_TOOLBAR, j as SET_EDITOR_KEY_MAP, m as SET_CRYPTO_KEYS, n as SET_CRYPTO_ENABLED, b as SET_EXPERIMENTAL } from "./settings-f2786260.js";
import { g as generateKeys, e as exportKeys } from "./doc-018f7423.js";
import { T as TOUCH_DOCUMENT } from "./actions-7ca2be11.js";
import { u as useStore } from "./vuex.esm-bundler-99de9736.js";
import Exporter from "./export-6092550a.js";
import Importer from "./import-54fb1be8.js";
...
const _hoisted_1$8 = /* @__PURE__ */ createBaseVNode("h3", { class: "text-3xl" }, "Appearance", -1);
const _hoisted_2$6 = /* @__PURE__ */ createBaseVNode("hr", { class: "mt-2 mb-4" }, null, -1);
const _hoisted_3$5 = { class: "mb-4" };
const _hoisted_4$5 = { class: "button button-size-medium button-color-gray" };
const _hoisted_5$4 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-3" }, "Auto", -1);
const _hoisted_6$3 = { class: "button button-size-medium button-color-gray ml-2" };
const _hoisted_7$3 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-3" }, "Dark", -1);
const _hoisted_8$2 = { class: "button button-size-medium button-color-gray ml-2" };
const _hoisted_9$2 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-3" }, "Light", -1);
const _hoisted_10$2 = { class: "button button-size-medium button-color-gray ml-2" };
const _hoisted_11$2 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-3" }, "Spooky", -1);
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_Extendable = __unplugin_components_0;
  return openBlock(), createElementBlock("section", null, [
    _hoisted_1$8,
    _hoisted_2$6,
    createVNode(_component_Extendable, { scope: "app.settings.appearance" }, {
      default: withCtx(() => [
        createBaseVNode("div", _hoisted_3$5, [
          createBaseVNode("div", null, [
            createBaseVNode("label", _hoisted_4$5, [
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.appearance = $event),
                type: "radio",
                value: "auto",
                class: "radio"
              }, null, 512), [
                [vModelRadio, _ctx.appearance]
              ]),
              _hoisted_5$4
            ]),
            createBaseVNode("label", _hoisted_6$3, [
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.appearance = $event),
                type: "radio",
                value: "dark",
                class: "radio"
              }, null, 512), [
            ...
            createBaseVNode("label", _hoisted_8$2, [
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => _ctx.appearance = $event),
                type: "radio",
                value: "light",
                class: "radio"
              }, null, 512), [
            ...
            createBaseVNode("label", _hoisted_10$2, [
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _ctx.appearance = $event),
                type: "radio",
                value: "october",
                class: "radio"
              }, null, 512), [
...
const Appearance = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$3]]);
const _hoisted_1$7 = {
  key: 0,
  class: "bg-gray-100 dark:bg-darkest text-center xl:text-left shadow rounded p-4 md:p-2"
};
const _hoisted_2$5 = { class: "flex flex-col lg:flex-row items-center justify-between gap-4" };
...
const _hoisted_5$3 = { class: "flex items-center justify-end" };
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return !unref(subscription).pro ? (openBlock(), createElementBlock("section", _hoisted_1$7, [
...
const _sfc_main$6 = {};
const _hoisted_1$6 = { class: "container flex flex-col mx-auto p-4 md:px-16 md:py-8" };
function _sfc_render$2(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$6, [
    renderSlot(_ctx.$slots, "default")
  ]);
}
const PageContainer = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$2]]);
const _sfc_main$5 = {
  computed: {
    imagesEnabled: {
      get() {
...
const _hoisted_1$5 = /* @__PURE__ */ createBaseVNode("h3", { class: "text-3xl" }, "Editor", -1);
const _hoisted_2$4 = /* @__PURE__ */ createBaseVNode("hr", { class: "mt-2 mb-4" }, null, -1);
const _hoisted_3$3 = /* @__PURE__ */ createBaseVNode("p", { class: "mb-6" }, "Configure settings for Ink - the Markdown editor that powers Octo.", -1);
const _hoisted_4$4 = { class: "mb-4" };
const _hoisted_5$2 = { class: "button button-size-medium button-color-gray items-center" };
const _hoisted_6$2 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-3" }, "Spellcheck", -1);
const _hoisted_7$2 = /* @__PURE__ */ createBaseVNode("small", { class: "text-gray-700" }, "Note: This will not disable Grammarly if you have the extension enabled.", -1);
const _hoisted_8$1 = { class: "mb-4" };
const _hoisted_9$1 = { class: "button button-size-medium button-color-gray items-center" };
const _hoisted_10$1 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-3" }, "Vim Mode", -1);
const _hoisted_11$1 = /* @__PURE__ */ createBaseVNode("small", { class: "text-gray-700" }, "Use Vim keybindings to edit your docs.", -1);
...
const Editor = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$1]]);
const _sfc_main$4 = {
  data() {
    return {
...
const _hoisted_4$3 = { class: "mb-4" };
const _hoisted_5$1 = { class: "button button-size-medium button-color-gray" };
const _hoisted_6$1 = ["disabled"];
const _hoisted_7$1 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-3" }, "Enable Encryption", -1);
const _hoisted_8 = { class: "text-gray-700" };
const _hoisted_9 = { key: 0 };
const _hoisted_10 = /* @__PURE__ */ createBaseVNode("strong", null, "requires", -1);
const _hoisted_11 = { class: "mb-4" };
const _hoisted_12 = /* @__PURE__ */ createBaseVNode("label", null, "Private Key", -1);
...
const _hoisted_15 = /* @__PURE__ */ createBaseVNode("label", null, "Public Key", -1);
  ...
  return openBlock(), createElementBlock("section", null, [
    ...
    createBaseVNode("div", _hoisted_4$3, [
      ...
      createBaseVNode("small", _hoisted_8, [
        ...
        !$options.allowCrypto ? (openBlock(), createElementBlock("span", _hoisted_9, [
...
const Encryption = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render]]);
const _hoisted_1$3 = /* @__PURE__ */ createBaseVNode("h3", { class: "text-3xl" }, "Experimental Features", -1);
const _hoisted_2$3 = /* @__PURE__ */ createBaseVNode("hr", { class: "mt-2 mb-4" }, null, -1);
const _hoisted_3$2 = { class: "flex flex-col gap-4" };
const _hoisted_4$2 = /* @__PURE__ */ createBaseVNode("p", null, "These features may be changed or removed at any time.", -1);
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("ul", { class: "flex flex-col gap-1 list-disc pl-4" }, [
...
const _hoisted_6 = { class: "button button-size-medium button-color-gray items-center" };
const _hoisted_7 = /* @__PURE__ */ createBaseVNode("span", { class: "ml-3" }, "Enable Experimental Features", -1);
...
const _hoisted_1$2 = /* @__PURE__ */ createBaseVNode("h3", { class: "text-3xl" }, "Export Docs", -1);
const _hoisted_2$2 = /* @__PURE__ */ createBaseVNode("hr", { class: "mt-2 mb-4" }, null, -1);
const _hoisted_3$1 = /* @__PURE__ */ createBaseVNode("div", { class: "mb-4" }, [
...
//# sourceMappingURL=settings-411b18d8.js.map
