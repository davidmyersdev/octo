  ...
  <div class="flex flex-col flex-grow flex-shrink min-h-0">
    <div class="flex flex-col flex-grow flex-shrink min-h-0 relative">
      <CoreScrollable ref="historyElement" class="flex-grow flex-shrink min-h-0">
        <div class="flex flex-col flex-grow gap-4 m-auto max-w-prose p-2">
        ...
        <CoreScrollable class="bg-layer-0 rounded max-h-[10rem]">
          <div class="flex gap-2">
            ...
            <div v-if="apiKey">
              ...
              <CoreButton v-else :disabled="isWaiting || !input" :layer="1" class="m-1 self-start sticky top-1" @click="onSend">
                <span v-if="isWaiting">
                  Waiting for a reply...
                </span>
                <span v-else class="flex items-center gap-2">
                  <span>Send</span>
                  <span v-if="isDesktop" class="hidden md:flex text-gray-500">
                    <Key>{{ modKey }}</Key>
                    <Key>⏎</Key>
                  </span>
                </span>
