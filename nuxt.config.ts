...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        { content: 'An open source tool for knowledge management.', name: 'description' },
        ...
        { property: 'og:description', content: 'An open source tool for knowledge management.' },
        ...
        { name: 'twitter:description', content: 'An open source tool for knowledge management.' },
