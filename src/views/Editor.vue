  ...
  <div @click="focusEditor" class="flex flex-col flex-grow">
    <div class="md:container md:mx-auto flex flex-grow">
      <div class="editor flex flex-col flex-grow min-w-0 p-4 md:px-16 md:py-0">
        ...
        <Ink v-if="ink" ref="editable" class="ink" :appearance="appearance" :extensions="extensions" :images="settings.images.enabled" :initialSelection="initialSelection" :spellcheck="spellcheck" :value="document.text" @input="input" />
